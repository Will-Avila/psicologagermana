...
const categories = [
    {
        ...
        icon: (
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.8}>
                ...
                <path strokeLinecap="round" strokeLinejoin="round" d="M9.5 9a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" d="M11.5 15a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0z" />
            </svg>
        ),
    },
    {
